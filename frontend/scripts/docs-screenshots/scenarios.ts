...
export const scenarios: DocScreenshotScenario[] = [
  ...
  },
  {
    ...
    actions: [
      { type: "wait", selector: "text=Storage usage" },
  ...
  },
  {
    ...
    storage: { ...baseStorage(storageUser), selectedWorkspace: "portal" },
    actions: [
      { type: "wait", selector: "text=Informations générales" },
      { type: "wait", selector: "text=Aperçu rapide" },
    ],
    mockRules: withBaseRules(),
  },
  {
    ...
    storage: { ...baseStorage(storageUser), selectedWorkspace: "portal" },
    actions: [
      { type: "wait", selector: "text=Usage by storage space" },
      { type: "wait", selector: "text=Billing source" },
    ],
    mockRules: withBaseRules(),
  },
  {
  ...
  },
  {
    ...
    actions: [
      ...
      { type: "click", selector: "section[aria-label='Operations'] button:has-text('Details')" },
