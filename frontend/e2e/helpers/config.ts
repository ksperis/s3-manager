...
export const E2E_FRONTEND_BASE_URL = process.env.E2E_FRONTEND_BASE_URL ?? "http://localhost:4173";
...
export const E2E_BROWSER_CONNECTION_NAME =
  process.env.E2E_BROWSER_CONNECTION_NAME ??
  process.env.E2E_SHARED_CONNECTION_NAME ??
  "Browser Moto E2E";
