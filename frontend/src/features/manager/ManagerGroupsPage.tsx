      ...
      <div className="rounded-2xl border border-slate-200/80 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
        <div className="flex items-center justify-between border-b border-slate-200 px-4 py-3 dark:border-slate-800">
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">List, members, and policies.</p>
          </div>
        </div>
        ...
        <Modal title="Create IAM group" onClose={closeAdvancedModal}>
          <form className="space-y-4" onSubmit={handleAdvancedCreate}>
            <div className="flex flex-col gap-2">
              <label className="text-sm font-semibold text-slate-700 dark:text-slate-200">Group name</label>
              <input
                type="text"
                value={advancedName}
            ...
            <div className="space-y-2 rounded-xl border border-dashed border-slate-200/80 p-3 dark:border-slate-700">
              <div className="flex flex-wrap items-center justify-between gap-2">
                <div>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400">Select managed policies to link immediately.</p>
                </div>
              ...
              {showPolicyOptions && (
                <>
                  ...
                  <p className="text-xs text-slate-500 dark:text-slate-400">Policies can also be attached later from the group page.</p>
                </>
              )}
            </div>
            <div className="space-y-2 rounded-xl border border-dashed border-slate-200/80 p-3 dark:border-slate-700">
