...
export default function ManagerRolePoliciesPage() {
  ...
  if (!roleName) {
    return <div className="text-sm text-slate-600">Role not specified.</div>;
  }

  if (needsS3AccountSelection) {
    return <div className="text-sm text-slate-600">Select an account before managing roles.</div>;
  }
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
          <div className="border-b border-slate-100 px-4 py-3 dark:border-slate-800">
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400">Attach/detach managed policies for this role.</p>
          </div>
