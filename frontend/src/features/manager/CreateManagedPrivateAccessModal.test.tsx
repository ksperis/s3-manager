...
describe("CreateManagedPrivateAccessModal", () => {
  ...
  it("submits only IAM provisioning choices and refreshes contexts without exposing a secret", async () => {
    ...
    expect(screen.getByText(/secret is never sent to this browser/i)).toBeInTheDocument();
