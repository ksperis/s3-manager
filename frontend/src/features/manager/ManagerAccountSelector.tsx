...
export default function ManagerS3AccountSelector({ accounts, selectedS3AccountId, onChange }: Props) {
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <select
        className="rounded-md border border-slate-200 bg-white px-3 py-2 text-sm text-slate-800 focus:border-primary focus:outline-none focus:ring-2 focus:ring-primary/30 dark:border-slate-700 dark:bg-slate-900 dark:text-slate-100"
