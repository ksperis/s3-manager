...
function CephAdminShell() {
  ...
  const pillClasses =
    "inline-flex h-9 min-w-[12rem] items-center rounded-md border border-slate-200 bg-white px-2.5 text-left shadow-sm dark:border-slate-700 dark:bg-slate-900";
