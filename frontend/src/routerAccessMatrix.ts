...
export const ROUTE_ACCESS_MATRIX: RouteAccessMatrixRow[] = [
  ...
  },
  {
    surface: "manager",
    route: "/manager/*",
    routeGuard: "RequireRole(ui_superadmin, ui_admin, ui_user)",
    featureGate: "none for workspace; per-tool gates only",
  ...
  },
  {
    surface: "ceph-admin",
    route: "/ceph-admin/*",
    routeGuard: "RequireRole(ui_superadmin, ui_admin), RequireCephAdminAccess",
    featureGate: "none",
  ...
  },
  {
    surface: "storage-ops",
    route: "/storage-ops/*",
    routeGuard: "RequireStorageOpsAccess",
    featureGate: "none",
