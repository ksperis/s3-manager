...
class StorageEndpoint(Base):
    ...
    ceph_zonegroup_name = Column(String, nullable=True)
    ceph_zone_name = Column(String, nullable=True)
    ceph_zonegroup_global_replication_configured = Column(Boolean, default=False, nullable=False, server_default="0")
    ceph_zonegroup_bucket_replication_allowed = Column(Boolean, default=False, nullable=False, server_default="0")
    ceph_bucket_replication_target_zones_json = Column(Text, nullable=False, default="[]", server_default="[]")
    ceph_bucket_replication_owner_mode = Column(String, nullable=False, default="rgw_user_only", server_default="rgw_user_only")
