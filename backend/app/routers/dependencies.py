...
from app.db_models import S3Account, S3User, StorageEndpoint, StorageProvider, User, UserS3Account, UserS3User, UserRole
...
def get_account_context(
    ...
    if isinstance(actor, User):
        ...
        account._manager_capabilities = AccountCapabilities(  # type: ignore[attr-defined]
            can_manage_buckets=bool(link.can_manage_buckets),
            can_manage_iam=bool(link.can_manage_iam or link.account_admin or link.is_root),
