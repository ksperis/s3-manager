...
revision = "0040_restore_portal_feature"
down_revision = "0039_user_manager_tool_access"
branch_labels = None
depends_on = None
...
def upgrade() -> None:
    ...
    with op.batch_alter_table("user_s3_accounts", schema=None) as batch_op:
        batch_op.alter_column("account_role", nullable=False, server_default="portal_none")
