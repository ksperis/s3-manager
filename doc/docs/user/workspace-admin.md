...
7. Use **Billing** to review monthly usage and estimated cost when the feature is enabled.
8. Use **Governance** for audit trail.
9. If superadmin, use **Settings** pages for global behavior.
