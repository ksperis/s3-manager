...
| Sibling page modes or metric sections | `PageTabs variant="bar"` | Prefer bar tabs for workspace metrics and dashboards; use card tabs when the tab content is a contained tool. |
